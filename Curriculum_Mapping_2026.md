...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **1** (Jun 22–26) | Data & Cloud Foundations | Data primer, DE roles, batch vs streaming, modern data stack | Cloud fundamentals: IaaS/PaaS/SaaS, GCP vs AWS, IAM, billing | Environment setup: VS Code, Codespaces, Git, Python venv | Hands-on GCS bucket lab; S3 comparison | **Data architectures** (Lambda/Kappa, Medallion) + architecture diagramming (Draw.io) + pipeline thread kickoff (NYC Taxi) |
